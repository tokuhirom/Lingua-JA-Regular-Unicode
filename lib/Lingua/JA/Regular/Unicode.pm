...
our @EXPORT = qw/ hiragana2katakana alnum_z2h space_z2h katakana2hiragana katakana_h2z/;
...
sub space_z2h {
    local $_ = shift;
    tr/\x{3000}/\x{0020}/; # convert \x{IDEOGRAPHIC SPACE} to \x{SPACE}
    $_;
}
